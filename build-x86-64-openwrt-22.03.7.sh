#!/bin/bash
filename="openwrt-sdk-22.03.7-x86-64_gcc-11.2.0_musl.Linux-x86_64.tar.xz"
...
if [[ -f "$filename" ]]; then
    ...
    wget "https://mirrors.sustech.edu.cn/openwrt/releases/22.03.7/targets/x86/64/openwrt-sdk-22.03.7-x86-64_gcc-11.2.0_musl.Linux-x86_64.tar.xz"
fi
...
if [ -n "$ipk_file" ]; then
  ...
  cp "$ipk_file" esurfingclient-x86_64-openwrt-22.03.7.ipk
else

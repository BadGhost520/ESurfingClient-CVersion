...
int main(const int argc, char* argv[]) {
    ...
    if (username && password && channel)
    {
        ...
        init_cipher("60639D8B-272E-4A4D-976E-AA270987A169");
        LOG_DEBUG("Before encrypt: 123abc456def");
        LOG_DEBUG("After encrypt: %s", sessionEncrypt("123abc456def"));
        LOG_DEBUG("Before decrypt: 1809009A34A3445E26B2C24BBFD86AC8A6C51E20A31FB9D1073F5612326F90F4DC3D452547FEA90B1F0B93D699234E5B6236605B1A50F928E086C22D5F50EBBB104BE42221B256DF");
        LOG_DEBUG("After decrypt: %s", sessionDecrypt("1809009A34A3445E26B2C24BBFD86AC8A6C51E20A31FB9D1073F5612326F90F4DC3D452547FEA90B1F0B93D699234E5B6236605B1A50F928E086C22D5F50EBBB104BE42221B256DF"));
        // while (isRunning) {
        //     // 你的业务逻辑
        //
        //     refreshStates();
